/* Files App 0.3.0 - https://files.photo.gallery/ */ ! function(e) {
    function t(e) {
    ...
    function le(e, t) {
        ...
        function d() {
            return _c.current_dir.html = M(_c.file_names, (function(e, r) {
                ...
                + (d ? "img" : "svg") 
                + '"' 
                + (c.preview_ratio ? ' style="--ratio:' + c.preview_ratio + '"' : "") 
                + ' data-name="' 
                + t(c.basename) 
                + '"' 
                ...
                + m(c.dimensions, "dimensions") + u(c, "size") 
                + g(c.image, "exif", "span") 
    ...
    ! function() {
        ...
        function V(e, a) {
            ...
            + (a ? P.get_svg_icon_multi_class("menu-icon menu-icon-toggle", "plus", "minus") : "") 
            // + (a ? P.get_svg_icon_multi_class("menu-icon menu-icon-folder menu-icon-folder-toggle", r, "folder_plus", "folder_minus") : P.get_svg_icon_class(r, "menu-icon menu-icon-folder")) 
            + '<div class="menu-text">'
            + i(e.basename) 
            + '</div>'
            + "</a>"
